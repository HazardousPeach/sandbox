...
This fork by Alex Sanchez-Stern includes patch mode for accepting and rejecting
hunks, a la the `-p` flag to various git commands. It is heavily clauded, use
at your own risk.
...
`-p, --patch`::
Interactively accept or reject changes by hunk
